...
public class StaticMethodReference {
	...
	public static void main(String[] args) {
		...
		FunctionInterface f1 = () -> {
			show();
		};
		FunctionInterface f2 = StaticMethodReference::show;
		f1.display();
		f2.display();

		Function<Integer, Double> f3 = (n) -> {
			return Math.sqrt(n);
		};
		...
		FunctionalInterface4 f5 = (n1, n2) -> add(n1, n2);
		FunctionalInterface4 f6 = StaticMethodReference::add;
		FunctionalInterface4 f7 = StaticMethodReference::sub;
